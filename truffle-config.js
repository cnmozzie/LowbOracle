 ...
 module.exports = {
   ...
   networks: {
     ...
     development: {
	  ...
	  mumbai: {
      provider: () => new HDWalletProvider(mnemonic, `https://rpc-mumbai.maticvigil.com/v1/`+PROJECT_ID),
      network_id: 80001,
	    gas: 3000000,
    ...
    matic: {
      provider: () => new HDWalletProvider(mnemonic, `https://rpc-mainnet.maticvigil.com/v1/`+PROJECT_ID),
      network_id: 137,
      confirmations: 2,
      timeoutBlocks: 200,
      skipDryRun: true
